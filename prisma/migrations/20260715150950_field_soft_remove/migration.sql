...
INSERT INTO "new_FieldDefinition" ("align", "direction", "fixedValue", "fontFamily", "fontSize", "id", "key", "kind", "label", "lang", "order", "printable", "rotationDeg", "source", "templateId", "widthMm", "xMm", "yMm") SELECT "align", "direction", "fixedValue", "fontFamily", "fontSize", "id", "key", "kind", "label", "lang", "order", "printable", "rotationDeg", "source", "templateId", "widthMm", "xMm", "yMm" FROM "FieldDefinition";
